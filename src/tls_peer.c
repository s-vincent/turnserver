...
/*
 *  Copyright (C) 2008 Sebastien Vincent.
 *
 ...
 */
static struct ssl_peer* ssl_peer_new(struct sockaddr* addr, socklen_t addrlen, SSL* ssl)
{
 ...
 */
static struct ssl_peer* tls_peer_find_connection(struct tls_peer* peer, const struct sockaddr* addr, socklen_t addrlen)
{
 ...
 */
static void tls_peer_add_connection(struct tls_peer* peer, struct ssl_peer* speer)
{
 ...
 */
static void tls_peer_remove_connection(struct tls_peer* peer, struct ssl_peer* ssl)
{
 ...
 */
static int tls_peer_load_certificates(SSL_CTX* ctx, const char* ca_file, const char* cert_file, const char* key_file)
{
 ...
 */
static int tls_peer_read(struct tls_peer* peer, char* buf, size_t buflen, char* bufout, size_t bufoutlen, struct ssl_peer* speer)
{
  BIO* bio_read = NULL;
  int len = -1;
  unsigned long err = 0;
...
int tls_peer_tcp_read(struct tls_peer* peer, char* buf, size_t buflen, char* bufout, size_t bufoutlen, const struct sockaddr* addr, socklen_t addrlen, int sock)
{
  struct ssl_peer* speer = NULL;
...
int tls_peer_udp_read(struct tls_peer* peer, char* buf, size_t buflen, char* bufout, size_t bufoutlen, const struct sockaddr* addr, socklen_t addrlen)
{
  struct ssl_peer* speer = NULL;
...
int tls_peer_write(struct tls_peer* peer, const char* buf, size_t buflen, const struct sockaddr* addr, socklen_t addrlen)
{
  BIO* bio_write = NULL;
  int len = -1;
  unsigned long err = 0;
