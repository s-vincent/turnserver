 ...
 *
 * TurnServer supports also RFC5389 (STUN Binding request), RFC6062 (relay data with TCP protocol)
 * and draft-ietf-behave-turn-ipv6 (relay IPv6-IPv6, IPv4-IPv6 and IPv6-IPv4) .
 * 
